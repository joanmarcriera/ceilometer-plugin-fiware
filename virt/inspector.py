...
MemoryResidentStats = collections.namedtuple('MemoryResidentStats', ['resident'])
...
# rx_packety: number of received packets
...
class Inspector(object):
    ...
    def inspect_disk_info(self, instance):
        ...
        I have added it looking at the kilo release
        :param instance_name: the name of the target instance
        :return: the number of CPUs and cumulative CPU time
        """
        raise ceilometer.NotImplementedError
    ...
    def inspect_memory_resident(self, instance_name, duration=None):
